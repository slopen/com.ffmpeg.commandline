...
public class BinaryInstaller  {
    ...
    public boolean installFromRaw () throws IOException, FileNotFoundException
    {
        ...
        InputStream is;
        File outFile;
        // int i = context.getResources().getIdentifier("ffmpeg","raw", context.getPackageName());
        is = context.getResources().openRawResource(context.getResources().getIdentifier("ffmpeg","raw", context.getPackageName()));
